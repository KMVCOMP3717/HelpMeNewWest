...
/**
 * Entity mapped to table "POLICE_STATIONS".
 */
@Entity
public class police_stations {
    ...
    public police_stations(Long id) {
        this.id = id;
    }

    @Generated
    public police_stations(Long id, String name, String building_id, String map_ref, String street_num, String street_name) {
        this.id = id;
        this.name = name;
