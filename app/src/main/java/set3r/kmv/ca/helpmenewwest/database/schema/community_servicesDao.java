...
/** 
 * DAO for table "COMMUNITY_SERVICES".
*/
public class community_servicesDao extends AbstractDao<community_services, Long> {

    public static final String TABLENAME = "COMMUNITY_SERVICES";

    /**
     * Properties of entity community_services.<br/>
    ...
    public community_servicesDao(DaoConfig config) {
        super(config);
    }
    
    public community_servicesDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"COMMUNITY_SERVICES\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"COMMUNITY_SERVICES\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, community_services entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, community_services entity) {
        stmt.clearBindings();
    ...
    @Override
    public community_services readEntity(Cursor cursor, int offset) {
        community_services entity = new community_services( //
    ...
    @Override
    public void readEntity(Cursor cursor, community_services entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(community_services entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(community_services entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(community_services entity) {
