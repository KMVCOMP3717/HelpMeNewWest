...
/** 
 * DAO for table "POLICE_STATIONS".
*/
public class police_stationsDao extends AbstractDao<police_stations, Long> {

    public static final String TABLENAME = "POLICE_STATIONS";

    /**
     * Properties of entity police_stations.<br/>
    ...
    public police_stationsDao(DaoConfig config) {
        super(config);
    }
    
    public police_stationsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"POLICE_STATIONS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"POLICE_STATIONS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, police_stations entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, police_stations entity) {
        stmt.clearBindings();
    ...
    @Override
    public police_stations readEntity(Cursor cursor, int offset) {
        police_stations entity = new police_stations( //
    ...
    @Override
    public void readEntity(Cursor cursor, police_stations entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(police_stations entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(police_stations entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(police_stations entity) {
