...
/** 
 * DAO for table "HOSPITALS".
*/
public class hospitalsDao extends AbstractDao<hospitals, Long> {

    public static final String TABLENAME = "HOSPITALS";

    /**
     * Properties of entity hospitals.<br/>
    ...
    public hospitalsDao(DaoConfig config) {
        super(config);
    }
    
    public hospitalsDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"HOSPITALS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"HOSPITALS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, hospitals entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, hospitals entity) {
        stmt.clearBindings();
    ...
    @Override
    public hospitals readEntity(Cursor cursor, int offset) {
    ...
    @Override
    public void readEntity(Cursor cursor, hospitals entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(hospitals entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(hospitals entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(hospitals entity) {
