...
/**
 * Entity mapped to table "FIRE_STATIONS".
 */
@Entity
public class fire_stations {
    ...
    @Generated
    public fire_stations() {
    }

    public fire_stations(Long id) {
        this.id = id;
    }

    @Generated
    public fire_stations(Long id, String name, String building_id, String map_ref_ref, String street_num, String street_name) {
        this.id = id;
        this.name = name;
