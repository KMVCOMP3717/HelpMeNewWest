 ...
 * DAO for table "PARKS".
*/
public class parksDao extends AbstractDao<parks, Long> {

    public static final String TABLENAME = "PARKS";

    /**
     * Properties of entity parks.<br/>
    ...
    public parksDao(DaoConfig config) {
        super(config);
    }
    
    public parksDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(Database db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PARKS\" (" + //
    ...
    public static void dropTable(Database db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"PARKS\"";
        db.execSQL(sql);
    }

    @Override
    protected final void bindValues(DatabaseStatement stmt, parks entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, parks entity) {
        stmt.clearBindings();
    ...
    @Override
    public parks readEntity(Cursor cursor, int offset) {
        parks entity = new parks( //
    ...
    @Override
    public void readEntity(Cursor cursor, parks entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(parks entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(parks entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(parks entity) {
